            ...
            <div class="card-body">
                ...
                <form action="/kasir/transaksi/detail/create" method="POST">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-md-8">
                            <input type="text" value="{{ isset($p_detail) ? $p_detail->stok : '' }}" class="form-control" disabled name="stok">
                        </div>
                    </div>
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-md-8">
                            <div class="d-flex">
                                <a href="?produk_id={{ request('produk_id') }}&act=min&qty={{ $qty }}" class="btn btn-primary"><i class="
                            fas fa-minus"></i></a>
                                <input type="number" value="{{ $qty }}" id="qty" class="form-control" name="qty">
                                <a href="?produk_id={{ request('produk_id') }}&act=plus&qty={{ $qty }}" class="btn btn-primary"><i class="
                            fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-md-8">
                            <a href="/kasir/transaksi" class="btn btn-info"><i class="fas fa-arrow-left"></i>
                                Kembali</a>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <a href="/kasir/transaksi/detail/selesai/{{ Request::segment(3) }}" class="btn btn-success"><i class="fas fa-check"></i> Konfirmasi</a>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <form action="" method="GET">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{ $transaksi->total }}" name="total_belanja" disabled class="form-control" id="">
                    </div>
