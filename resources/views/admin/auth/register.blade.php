...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="{{ route('login') }}" class="h3"><b>Register</b></a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Mohon Isi Data Berikut</p>
      ...
      <a href="/login" class="btn btn-info btn-primary btn-block">Kembali</a>
