                ...
                <div class="card-body">
                    <div class="container-fluid d-flex justify-content-between">
                        <div class="col-lg-3 ps-0">
                            <p class="mt-1 mb-1 larger-text"><b>Lockhart Book Store  </b></p>
                            <p class="larger-text">Jalan Raya SumberBaru,<br> Kec. Sidomungkul,<br>Jawa Selatan 61252.</p>
                            <h5 class="mt-5 mb-2 text-muted larger-text" style="margin-bottom: 0.25rem;">Nyzz</h5>
